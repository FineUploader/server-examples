import os.path
# Django settings for python_django_s3 project.
...
SECRET_KEY = 'vu9^u*8gj5o_dg4%lejn2*)lfv)u4m49ydqw7n8%=(=uh8hmqr'
...
ROOT_URLCONF = 'python_django_s3.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'python_django_s3.wsgi.application'
